...
It is necessary to set up a Redis database for the Docmost instance. Valkey can also be used instead.
...
See its [environment variables](https://docmost.com/docs/self-hosting/environment-variables) for a complete list of Docmost's config options that you can put in `docmost_environment_variables_additional_variables`.
